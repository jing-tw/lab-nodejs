...
class TestStreamWAVFile {
    ...
    let offset = 44;
      ...
      if (offset + lengthBufDataPerFrame < byteBuffer.length){
        ...
        // console.log('bufData.length = ', bufData.length);  // 160 bytes
        offset = offset + lengthBufDataPerFrame;
      }else{
        bufData = new Buffer.alloc(lengthBufDataPerFrame);
        offset = 44;
      }
      ...
      let intDelayInms = 0; // secondsPerSample*numberOfFrames*1000;
