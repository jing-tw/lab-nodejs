...
Client
-----
- client_data.js:: send audio data chunk to server http://localhost:1337
- browser consume the audio chunk via http://localhost:3000


Architecture
-----
client_data.js --------> [:1337] Server (index.js) [:3000] ------------------> browser 
